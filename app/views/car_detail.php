...
<head>
    ...
    <style>
        ...
        .thumbnails-row {
            ...
            gap: 10px;
            padding: 15px 30px;
            background: #1e293b; /* Тъмен фон за контраст */
            overflow-x: auto; /* Позволява скролване, ако снимките са много */
            justify-content: center;
        }
        ...
        .thumb-img:hover, .thumb-img.active {
            border-color: #3b82f6; /* Синя рамка за активната снимка */
            opacity: 1;
...
<?php if ($car): ?>
    ...
    <div class="main-card">
        <div class="top-bar">
            <a href="index.php?url=public" class="back-link">
